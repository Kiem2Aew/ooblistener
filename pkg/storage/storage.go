...
// for ooblistener external interaction data.
package storage
...
// Storage is an storage for ooblistener interaction data as well
...
func (s *Storage) SetIDPublicKey(correlationID, secretKey string, publicKey string) error {
	...
	// Шифрование симметричного ключа шифрования (для AES), с помощью публичного ключа клиента
